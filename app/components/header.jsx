...
export function Header() {
    ...
    useEffect(() => {
        setShowHeader(false);
        const timeout = setTimeout(() => setShowHeader(true), 200);
      ...
      bg-white dark:bg-black ${
        ...
        >
            <div className="max-w-8xl mx-auto flex justify-between items-center px-4 py-2">
                            ...
                            <MenubarContent>
                                ...
                                <MenubarSub>
                                    ...
                                    <MenubarSubContent>
                                        ...
                                        <MenubarItem asChild>
                                            <Link href="/controller/deltacnc">Adtech CNC</Link>
                                        </MenubarItem>
                                    </MenubarSubContent>
                                </MenubarSub>

                                <MenubarItem asChild>
                                    <Link href="/cncautoloader">CNC AUTOLOADER</Link>
                                </MenubarItem>
                                <MenubarItem asChild>
                                    <Link href="/robotics">ROBOTICS</Link>
                                </MenubarItem>
                                <MenubarItem asChild>
                                    <Link href="/spmmachine">SPM MACHINE</Link>
                                </MenubarItem>
                            </MenubarContent>
                        </MenubarMenu>
                ...
                {/* ✅ Mobile Menu Button (same row as logo) */}
                <div className="md:hidden flex items-center">
                    <Link
                        href="/menu"
                        className="flex items-center gap-2 px-3 py-2 text-lg font-semibold hover:text-blue-400 transition duration-300 ease-in-out"
